...
*   **Gestion des Chantiers (Coordinator) :**
    ...
    *   **Journal des Anomalies :** Vue dédiée (`/anomalies`) avec **galerie photo avant/après réparation**. La résolution remet automatiquement le matériel en service (`status = OK`).
